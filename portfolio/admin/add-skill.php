                                      ...
                                      <div class="card card-outline card-info">
                                        ...
                                        <div class="card-header">
                                         <div class="form-group">
                                             ...
                                             <input name="title" value="" type="text" class="form-control" placeholder="Enter  Skill Name...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-header">
                                         <div class="form-group">
                                             ...
                                             <input name="skillp" value="" type="text" class="form-control" placeholder="Enter kill percentage..">
                                            </div>
                                        </div>
           ...
           if (isset($_POST['publise']))
            {
               ...
               $skillp=$_POST['skillp'];
                    ...
                    $sql=" INSERT INTO `skill`( `sname`, `spercentage`) VALUES ('$name','$skillp')";
