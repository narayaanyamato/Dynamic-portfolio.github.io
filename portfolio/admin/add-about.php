        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6 ">
                              <h1 class="h3 mb-4 text-gray-800">Add Abou Us Details</h1>
                        </div>
                        <div class="col-sm-6">
                            <a href="view-about.php" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i>  View About</a>
                        </div>
                                      ...
                                      <div class="card card-outline card-info">
                                        ...
                                        <div class="card-header">
                                         <div class="form-group">
                                             ...
                                             <input name="email" value="" type="text" class="form-control" placeholder="Enter  Email...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-header">
                                         <div class="form-group">
                                             ...
                                             <input name="phone" value="" type="text" class="form-control" placeholder="Enter  Phone...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-header">
                                         <div class="form-group">
                                             ...
                                             <input name="doj" value="" type="date" class="form-control" placeholder="Enter  Phone...">
                                            </div>
                                        </div>
                  ...
                  if(is_uploaded_file($_FILES['lis_img']['tmp_name']))
                   {
                    ...
                    $sql="INSERT INTO `about`(`id`, `name`, `Designation`, `email`, `phone`, `description`, `img`, `dob`) VALUES (null,'$name','$deg','$email','$phone','$desc','$fname','$dob')";
