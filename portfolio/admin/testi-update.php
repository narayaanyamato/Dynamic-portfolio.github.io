                    ...
                    <div class="row">
                     ...
                     <?php 
                                $id=$_GET['id'];
                                   echo $id;
                                   include('db/db.php');
                                    $resultt = mysqli_query($con,"SELECT * FROM `testimonial` WHERE  id='$id'");
                                      ...
                                      <div class="card card-outline card-info">
                                        ...
                                        <div class="card-header">
                                         <div class="form-group">
                                             ...
                                             <input name="title" value="<?php echo $row['cname'] ?>" type="text" class="form-control" placeholder="Enter Name...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <p style="color:red;">img size 70px x 70px</p>
                                                    <input name="lis_img" value="<?php echo $row['img'] ?>" type="file" required="" accept=".jpg,.jpeg,.png,svg">

                                                    <img src="upload/testimonals/<?php echo $row['img']; ?>" alt="John" style="width:70px; height: 70px;">
                                                    <?php echo $row['img']; ?>
                                                                   </div>
                                        </div>
                  ...
                  if(is_uploaded_file($_FILES['lis_img']['tmp_name']))
                   {
                    ...
                    $sql=" UPDATE `testimonial` SET `id`='$id',`cname`='$name',`descr`='$desc',`img`='$fname' WHERE id='$id' ";
                    
                    if(mysqli_query($con,$sql))
                    {
                   echo "<script>alert('Published Successfull');window.open('view-testimonal.php','_self');</script>";
                    }

                    else
                    {
                        echo "<script>alert('Some thing wrong try again');window.open('view-testimonal.php','_self');</script>";
                    }
