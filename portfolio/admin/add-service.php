            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="view-service.php" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i>  View Service</a>
                        </div>
                  ...
                  if(is_uploaded_file($_FILES['lis_img']['tmp_name']))
                   {
                    ...
                    $sql=" INSERT INTO `service`( `sname`, `sdesc`, `icon`) VALUES ('$name','$desc','$fname')";
